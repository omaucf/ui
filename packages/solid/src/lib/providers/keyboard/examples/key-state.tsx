    ...
    <div class="flex w-full max-w-[26rem] flex-col gap-4 rounded-[0.875rem] border border-default bg-elevated p-5 text-highlighted text-sm shadow-sm">
      ...
      <div class="flex flex-col items-start gap-2 border-default border-t pt-3.5">
        ...
        <div class="flex min-h-7 flex-wrap items-center gap-1.5">
          <Show
            fallback={<span class="text-highlighted italic">nothing</span>}
            when={pressedKeys().length > 0}
          >
            <For each={pressedKeys()}>
              {(key) => (
                <kbd
                  class="inline-flex items-center gap-0.5 whitespace-nowrap rounded-md border border-default border-b-2 bg-accented px-[0.4375rem] py-[0.1875rem] font-semibold text-highlighted text-xs data-[active]:border-muted data-[active]:bg-elevated data-[active]:text-primary"
                  data-active=""
                >
                  {key}
                </kbd>
      ...
      <div class="flex flex-col items-start gap-2 border-default border-t pt-3.5">
        ...
        <span
          class="inline-flex items-center gap-1.5 rounded-full bg-accented px-2 py-[0.1875rem] font-semibold text-muted text-xs data-[state=active]:bg-elevated data-[state=active]:text-primary"
