...
export interface ProseH4BaseProps extends PolymorphicProps<"h4">, RefAttribute {
  anchor?: boolean;
}

export interface ProseH4Props extends ProseH4BaseProps, HTMLProps<"h4"> {
  ui?: Partial<ProseH4Theme["slots"]>;
}
