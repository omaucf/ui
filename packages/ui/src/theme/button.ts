...
export default (options: Options) =>
  cc({
    slots: {
      base: [
        "inline-flex items-center rounded-md font-medium disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:cursor-not-allowed aria-disabled:opacity-75",
    ...
    compoundVariants: [
      ...
      })),
      {
        ...
        variant: "solid",
        class:
          "bg-inverted text-inverted hover:bg-inverted/90 focus-visible:outline-2 focus-visible:outline-inverted focus-visible:outline-offset-2 active:bg-inverted/90 disabled:bg-inverted aria-disabled:bg-inverted",
      },
      {
        color: "neutral",
        variant: "outline",
        class:
          "bg-default text-default ring ring-accented ring-inset hover:bg-elevated focus:outline-none focus-visible:ring-2 focus-visible:ring-inverted active:bg-elevated disabled:bg-default aria-disabled:bg-default",
      },
      {
        color: "neutral",
        variant: "soft",
        class:
          "bg-elevated text-default hover:bg-accented/75 focus:outline-none focus-visible:bg-accented/75 active:bg-accented/75 disabled:bg-elevated aria-disabled:bg-elevated",
      },
      {
        color: "neutral",
        variant: "subtle",
        class:
          "bg-elevated text-default ring ring-accented ring-inset hover:bg-accented/75 focus:outline-none focus-visible:ring-2 focus-visible:ring-inverted active:bg-accented/75 disabled:bg-elevated aria-disabled:bg-elevated",
      },
      {
        color: "neutral",
        variant: "ghost",
        class:
          "text-default hover:bg-elevated focus:outline-none focus-visible:bg-elevated active:bg-elevated hover:disabled:bg-transparent hover:aria-disabled:bg-transparent dark:hover:aria-disabled:bg-transparent dark:hover:disabled:bg-transparent",
      },
      {
        color: "neutral",
        variant: "link",
        class:
          "text-muted hover:text-default focus:outline-none focus-visible:ring-2 focus-visible:ring-inverted focus-visible:ring-inset active:text-default disabled:text-muted aria-disabled:text-muted",
      },
      {
        size: "xs",
        square: true,
