...
export default (options: Options) =>
  cc({
    slots: {
      ...
      cellTrigger: [
        "relative m-0.5 flex items-center justify-center whitespace-nowrap rounded-full focus:outline-none focus-visible:ring-2 data-unavailable:pointer-events-none data-today:font-semibold data-disabled:text-muted data-outside-view:text-muted data-unavailable:text-muted data-unavailable:line-through",
    ...
    compoundVariants: [
      ...
      })),
      {
        ...
        class: {
          cellTrigger:
            "hover:not-data-selected:bg-inverted/10 data-highlighted:bg-inverted/20 data-selected:bg-inverted data-selected:text-inverted data-today:not-data-selected:text-highlighted",
        },
      },
      {
        color: "neutral",
        ...
        class: {
          cellTrigger:
            "hover:not-data-selected:bg-inverted/10 data-highlighted:bg-inverted/10 data-selected:bg-default data-selected:text-default data-today:not-data-selected:text-highlighted data-selected:ring data-selected:ring-accented data-selected:ring-inset",
        },
      },
      {
        color: "neutral",
        ...
        class: {
          cellTrigger:
            "hover:not-data-selected:bg-inverted/10 data-highlighted:bg-inverted/20 data-selected:bg-elevated data-selected:text-default data-today:not-data-selected:text-highlighted",
        },
      },
      {
        color: "neutral",
        ...
        class: {
          cellTrigger:
            "hover:not-data-selected:bg-inverted/10 data-highlighted:bg-inverted/20 data-selected:bg-elevated data-selected:text-default data-today:not-data-selected:text-highlighted data-selected:ring data-selected:ring-accented data-selected:ring-inset",
        },
      },
    ],
    defaultVariants: {
