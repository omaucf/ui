    ...
    variants: {
      ...
      color: {
        ...Object.fromEntries(
          (options.theme?.colors || []).map((color: string) => [
            color,
            { indicator: `bg-${color}`, steps: `text-${color}` },
          ])
        ),
        neutral: {
      ...
      orientation: {
        horizontal: {
          ...
          base: "w-full",
          status: "min-w-fit flex-row items-center justify-end",
        },
        vertical: {
          root: "flex h-full flex-row-reverse",
          base: "h-full",
          status: "min-h-fit flex-col justify-end",
        },
      },
      inverted: {
        true: {
